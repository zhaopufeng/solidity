...
While any version of ``cpp-ethereum`` should be usable, this cannot be guaranteed, and it is suggested to use the same version as used by the Solidity continuous integration tests are doing.
